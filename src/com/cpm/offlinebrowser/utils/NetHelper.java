...
public class NetHelper {
	...
	public static String GetContentFromUrl(String url) {
		...
		try {
			...
			Log.e("NetHelper", "读取数据失败 GetContentFromUrl" + e.toString() + url);
			e.printStackTrace();
			return "";
		}
	}
	...
	public static String GetContentFromUrl(String url, String contentType) {
		...
		try {
			...
			Log.e("NetHelper", "______________读取数据失败 GetContentFromUrl" + e.toString()
					+ url);
			e.printStackTrace();
			return "";
		}
	...
	public static String GetContentFromUrlByPostParams(String url,
		...
		try {
			...
			Log.e("NetHelper", "______________读取数据失败 GetContentFromUrlByPostParams" + e.toString()
					+ url);
			e.printStackTrace();
		}
		httpClient.getConnectionManager().shutdown();
